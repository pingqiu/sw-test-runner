...
The runner source is `sw-test-runner-standalone` (module
`github.com/pingqiu/sw-test-runner`). One binary is built **per product** — each
...
```bash
cd /c/work/seaweedfs/learn/sw-test-runner-standalone
